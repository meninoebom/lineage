...
connections:
  ...
  - tradition_slug: bon
    connection_type: related_to
    strength: 3
    description: Bön preserves its own Dzogchen lineage through the Zhang Zhung Nyengyud, developed in parallel with Buddhist Dzogchen. Practitioners of each tradition recognize the two as pointing to the same nature of mind.
---
