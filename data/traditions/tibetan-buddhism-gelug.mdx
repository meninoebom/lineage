...
connections:
  ...
  - tradition_slug: tibetan-buddhism-nyingma
    connection_type: related_to
    strength: 2
    description: Nyingma is the oldest Tibetan school, predating Gelug by six centuries. Both share a common Indian Mahayana and Vajrayana foundation but differ in method — Nyingma emphasizes direct recognition (Dzogchen), Gelug emphasizes graduated analytical training.
  - tradition_slug: tibetan-buddhism-kagyu
    connection_type: related_to
    strength: 2
    description: Kagyu and Gelug are sibling schools of Tibetan Buddhism with a shared foundation but different emphases — Kagyu centers on Mahamudra and direct recognition, Gelug on the graduated path and analytical philosophy.
